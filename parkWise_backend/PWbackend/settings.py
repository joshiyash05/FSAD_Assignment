"""
Django settings for PWbackend project.
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'drf_spectacular', # Added for API schema and documentation
    'api',
]
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'ParkWise API',
    'DESCRIPTION': 'A comprehensive API for the ParkWise parking reservation system. '
                   'Manage spots, reservations, vehicles, and payments with ease.',
    'VERSION': '1.0.0',
